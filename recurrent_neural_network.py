...
df = pd.read_csv("gemini_embeddings.csv")
df
...
def ejecucion_modelo(X, y, input_size, hidden_size, num_layers, num_classes,learning_rate,batch_size,num_epochs,porcentage):
  ...
  losses = []
  print(f"Entrenando modelo con {num_epochs}, tasa de aprendizaje {learning_rate} y procentage del corpus {1-porcentage}")
